...
### 5. Show changes and wait for approval

- Summarize the changes made: files modified, logic added/removed, tests updated
- Show a `git diff --stat` to give the user a concise overview
- **Wait for the user to explicitly approve before continuing**
- If the user requests changes, go back to step 3 and adjust accordingly
